...
const en: Dict = {
  ...
  settingsSubtitle: "Account profile and preferences",
  ...
  planSectionSubtitle: "Your current subscription and usage",
  waAccountsUsage: (used: number, max: string) => `${used} / ${max} WA accounts`,
  teamMembersUsage: (used: number, max: string) => `${used} / ${max} team members`,
  ...
  retryingWebhook: "Retrying...",
  exportCSV: "Export CSV",
  refreshNow: "Refresh",
  confirmDeletePhone: "Remove this phone number?",
  webhookErrorLabel: "Webhook error:",
  autoRefreshNote: "Auto-refreshes every 15 min",
  connectedAccounts: "Connected Accounts",
  connectedAccountsSubtitle: "Manage your Cloud API credentials",
  webhookOk: "Webhook active",
  ...
  goToSettingsImport: "Go to Phone Numbers → Import your first account first.",
...
const zh: Dict = {
  ...
  // ── Settings page
  settingsTitle: "设置",
  settingsSubtitle: "账户资料与偏好设置",
  profileSection: "个人资料",
  profileSubtitle: "更新您的显示名称",
  fieldName: "显示名称",
  updateProfile: "更新资料",
  updatingProfile: "更新中...",
  ...
  planSection: "计划与用量",
  planSectionSubtitle: "您当前的订阅和使用情况",
  waAccountsUsage: (used: number, max: string) => `${used} / ${max} 个 WA 账户`,
  teamMembersUsage: (used: number, max: string) => `${used} / ${max} 位团队成员`,
  ...
  exportCSV: "导出 CSV",
  refreshNow: "刷新",
  confirmDeletePhone: "删除此电话号码？",
  webhookErrorLabel: "Webhook 错误：",
  autoRefreshNote: "每 15 分钟自动刷新",
  connectedAccounts: "已连接账户",
  connectedAccountsSubtitle: "管理您的 Cloud API 凭据",
  webhookOk: "Webhook 正常",
  webhookFailed: "Webhook 失败",
  ...
  goToSettingsImport: "请先前往"电话号码"导入您的第一个账户。",
